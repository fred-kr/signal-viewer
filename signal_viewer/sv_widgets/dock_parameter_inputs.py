...
# from signal_viewer.sv_widgets.dock_param_inputs import Inputs
...
# def _fill_combo_box_with_enum(
#     combo_box: QtWidgets.QComboBox, enum_class: type[enum.Enum], allow_none: bool = False
# ) -> None:
#     combo_box.clear()
...
#         self._on_peak_detection_method_changed(self.inputs.ui.peak_method.currentData())

#     @property
#     def filter_inputs(self) -> list[QtWidgets.QWidget]:
#         return self.inputs.sf_widgets

#     @property
#     def standardization_inputs(self) -> list[QtWidgets.QWidget]:
#         return self.inputs.std_widgets

#     def _setup_status_indicators(self) -> None:
#         self.inputs.ui.status_pipeline.setFixedSize(20, 20)
#         self.inputs.ui.status_filter.setFixedSize(20, 20)
#         self.inputs.ui.status_standardization.setFixedSize(20, 20)
#         self.reset_status_indicators()

#     def set_pipeline_status(self, status: bool) -> None:
#         self.inputs.ui.status_pipeline.setIcon(
...
#         self.inputs.ui.status_filter.setIcon(
#             QtGui.QIcon("://icons/CheckmarkCircle.svg") if status else QtGui.QIcon("://icons/Circle.svg")
#         )
#         self.inputs.ui.status_filter.setToolTip(f"Filtered {times_filtered} times")

#     def set_standardization_status(self, status: bool) -> None:
#         self.inputs.ui.status_standardization.setIcon(
#             QtGui.QIcon("://icons/CheckmarkCircle.svg") if status else QtGui.QIcon("://icons/Circle.svg")
#         )
...
#     #     _fill_combo_box_with_enum(self.inputs.ui.sf_pipeline, PreprocessPipeline, allow_none=True)
#     #     _fill_combo_box_with_enum(self.inputs.ui.sf_method, FilterMethod, allow_none=True)
#     #     _fill_combo_box_with_enum(self.inputs.ui.peak_method, PeakDetectionMethod)
#     #     _fill_combo_box_with_enum(self.inputs.ui.std_method, StandardizationMethod, allow_none=True)
#     #     _fill_combo_box_with_enum(self.inputs.peak_neurokit2_algorithm_used, NK2ECGPeakDetectionMethod)
#     #     _fill_combo_box_with_enum(self.inputs.peak_xqrs_peak_dir, WFDBPeakDirection)
#     #     _fill_combo_box_with_enum(self.inputs.combo_incomplete_window_method, IncompleteWindowMethod)

#     def _setup_actions(self) -> None:
#         # Peak Detection
#         # Actions
#         self.inputs.action_peak_reset_data.triggered.connect(self.sig_clear_peaks_requested)
#         self.inputs.action_peak_run.triggered.connect(self._on_run_peak_detection)
#         self.inputs.action_peak_reset_inputs.triggered.connect(self._on_restore_defaults_peak_detection)
#         # Widgets
#         self.inputs.ui.peak_method.currentIndexChanged.connect(
#             lambda: self._on_peak_detection_method_changed(self.inputs.ui.peak_method.current_enum())
#         )
#         # self.inputs.ui.currentIndexChanged.connect(
#         #     lambda: self._show_nk_peak_algorithm_inputs(self.inputs.peak_neurokit2_algorithm_used.currentData())
#         # )

#         # Processing
#         # Actions
#         self.inputs.action_sf_run.triggered.connect(self._on_run_processing)
#         self.inputs.action_restore_defaults_processing.triggered.connect(self._on_restore_defaults_processing)
#         self.inputs.action_restore_original_values.triggered.connect(self.sig_data_reset_requested)
#         # Widgets
#         self.inputs.combo_pipeline.currentIndexChanged.connect(lambda: self._on_pipeline_changed())
#         self.inputs.combo_filter_method.currentIndexChanged.connect(lambda: self._on_filter_method_changed())
#         self.inputs.combo_standardize_method.currentIndexChanged.connect(lambda: self._on_standardize_method_changed())
#         self.inputs.switch_btn_standardize_rolling_window.checkedChanged.connect(self._on_switch_toggled)

#     @QtCore.Slot(bool)
#     def _on_switch_toggled(self, checked: bool) -> None:
#         self.inputs.container_standardize_rolling_window.setEnabled(checked)
#         self.inputs.sb_standardize_window_size.setEnabled(checked)

#     def _setup_command_bars(self) -> None:
#         # Peak Detection
#         self.inputs.command_bar_peak_detection.setToolButtonStyle(QtCore.Qt.ToolButtonStyle.ToolButtonTextUnderIcon)
#         self.inputs.command_bar_peak_detection.addActions(
#             [
#                 self.inputs.action_run_peak_detection,
#                 self.inputs.action_clear_peaks,
#                 self.inputs.action_restore_defaults_peak_detection,
#             ]
#         )

#         # Processing
#         self.inputs.command_bar_processing.setToolButtonStyle(QtCore.Qt.ToolButtonStyle.ToolButtonTextUnderIcon)
#         self.inputs.command_bar_processing.addActions(
#             [
#                 self.inputs.action_run_processing,
#                 self.inputs.action_restore_original_values,
#                 self.inputs.action_restore_defaults_processing,
#             ]
#         )

#     @QtCore.Slot()
#     def _on_pipeline_changed(self) -> None:
#         pipeline = self.inputs.combo_pipeline.currentData()
#         if pipeline is None:
#             self.inputs.combo_filter_method.setEnabled(True)
#             self.inputs.combo_standardize_method.setEnabled(True)
#         else:
#             self.inputs.combo_filter_method.setCurrentIndex(0)
#             self.inputs.combo_standardize_method.setCurrentIndex(0)
#             self.inputs.combo_filter_method.setEnabled(False)
#             self.inputs.combo_standardize_method.setEnabled(False)

#     @QtCore.Slot()
#     def _on_filter_method_changed(self) -> None:
#         filter_method = self.inputs.combo_filter_method.currentData()
...
#             self.inputs.dbl_sb_lower_cutoff.setEnabled(True)
#             self.inputs.dbl_sb_upper_cutoff.setEnabled(True)
#             self.inputs.sb_filter_order.setEnabled(True)
#             self.inputs.sb_filter_window_size.setEnabled(False)
#             self.inputs.dbl_sb_powerline.setEnabled(False)
#         elif filter_method == FilterMethod.SavGol:
#             self.inputs.dbl_sb_lower_cutoff.setEnabled(False)
#             self.inputs.dbl_sb_upper_cutoff.setEnabled(False)
#             self.inputs.sb_filter_order.setEnabled(True)
#             self.inputs.sb_filter_window_size.setEnabled(True)
#             self.inputs.dbl_sb_powerline.setEnabled(False)
#         elif filter_method == FilterMethod.FIR:
#             self.inputs.dbl_sb_lower_cutoff.setEnabled(True)
#             self.inputs.dbl_sb_upper_cutoff.setEnabled(True)
#             self.inputs.sb_filter_order.setEnabled(False)
#             self.inputs.sb_filter_window_size.setEnabled(True)
#             self.inputs.dbl_sb_powerline.setEnabled(False)
...
#             self.inputs.sb_filter_order.setEnabled(False)
#             self.inputs.sb_filter_window_size.setEnabled(False)
#             self.inputs.dbl_sb_powerline.setEnabled(True)

#     @QtCore.Slot()
#     def _on_standardize_method_changed(self) -> None:
#         standardize_method = self.inputs.combo_standardize_method.currentData()
...
#             self.inputs.switch_btn_standardize_rolling_window.setEnabled(True)
#         else:
#             self.inputs.switch_btn_standardize_rolling_window.setChecked(False)
#             self.inputs.switch_btn_standardize_rolling_window.setEnabled(False)
...
#         window = self.inputs.sb_filter_window_size
#         if window.value() == window.minimum():
#             window_size = "default"
#         else:
#             window_size = window.value()
#         return {
#             "lowcut": self.inputs.dbl_sb_lower_cutoff.value(),
#             "highcut": self.inputs.dbl_sb_upper_cutoff.value(),
#             "method": method,
#             "order": self.inputs.sb_filter_order.value(),
#             "window_size": window_size,
#             "powerline": self.inputs.dbl_sb_powerline.value(),
#         }

#     def _get_standardize_params(self, method: StandardizationMethod) -> _t.StandardizationParameters:
#         return {
#             "method": method,
#             "window_size": self.inputs.sb_standardize_window_size.value()
#             if self.inputs.switch_btn_standardize_rolling_window.isChecked()
#             else None,
#         }

#     @QtCore.Slot()
#     def _on_run_peak_detection(self) -> None:
#         peak_method = PeakDetectionMethod(self.inputs.combo_peak_method.currentData())
...
#             self.inputs.stacked_peak_parameters.setCurrentWidget(self.inputs.page_peak_elgendi_ppg)
#         elif peak_method == PeakDetectionMethod.ECGNeuroKit2:
#             self.inputs.stacked_peak_parameters.setCurrentWidget(self.inputs.page_peak_neurokit2)
#             self._show_nk_peak_algorithm_inputs(self.inputs.peak_neurokit2_algorithm_used.currentData())
#         elif peak_method == PeakDetectionMethod.LocalMaxima:
#             self.inputs.stacked_peak_parameters.setCurrentWidget(self.inputs.page_peak_local_max)
#         elif peak_method == PeakDetectionMethod.LocalMinima:
#             self.inputs.stacked_peak_parameters.setCurrentWidget(self.inputs.page_peak_local_min)
#         elif peak_method == PeakDetectionMethod.WFDBXQRS:
#             self.inputs.stacked_peak_parameters.setCurrentWidget(self.inputs.page_peak_xqrs)
...
#             self.inputs.stacked_nk2_method_parameters.setCurrentWidget(self.inputs.nk2_page_neurokit)
#         elif method == NK2ECGPeakDetectionMethod.Promac:
#             self.inputs.stacked_nk2_method_parameters.setCurrentWidget(self.inputs.nk2_page_promac)
#         elif method == NK2ECGPeakDetectionMethod.Gamboa2008:
#             self.inputs.stacked_nk2_method_parameters.setCurrentWidget(self.inputs.nk2_page_gamboa)
#         elif method == NK2ECGPeakDetectionMethod.Emrich2023:
#             self.inputs.stacked_nk2_method_parameters.setCurrentWidget(self.inputs.nk2_page_emrich)
#         else:
#             self.inputs.stacked_nk2_method_parameters.setCurrentWidget(self.inputs.nk2_page_no_params)
...
#                 peakwindow=self.inputs.peak_elgendi_ppg_peakwindow.value(),
#                 beatwindow=self.inputs.peak_elgendi_ppg_beatwindow.value(),
#                 beatoffset=self.inputs.peak_elgendi_ppg_beatoffset.value(),
#                 mindelay=self.inputs.peak_elgendi_ppg_mindelay.value(),
#             )
#         elif method == PeakDetectionMethod.ECGNeuroKit2:
#             nk_algorithm = NK2ECGPeakDetectionMethod(self.inputs.peak_neurokit2_algorithm_used.currentData())
#             if nk_algorithm == NK2ECGPeakDetectionMethod.Default:
#                 nk_params = _t.NK2PeaksNeuroKit(
#                     smoothwindow=self.inputs.peak_neurokit2_smoothwindow.value(),
#                     avgwindow=self.inputs.peak_neurokit2_avgwindow.value(),
#                     gradthreshweight=self.inputs.peak_neurokit2_gradthreshweight.value(),
#                     minlenweight=self.inputs.peak_neurokit2_minlenweight.value(),
#                     mindelay=self.inputs.peak_neurokit2_mindelay.value(),
#                 )
#             elif nk_algorithm == NK2ECGPeakDetectionMethod.Promac:
#                 nk_params = _t.NK2PeaksPromac(
#                     threshold=self.inputs.peak_promac_threshold.value(),
#                     gaussian_sd=self.inputs.peak_promac_gaussian_sd.value(),
#                 )
#             elif nk_algorithm == NK2ECGPeakDetectionMethod.Gamboa2008:
#                 nk_params = _t.NK2PeaksGamboa(tol=self.inputs.peak_gamboa_tol.value())
#             elif nk_algorithm == NK2ECGPeakDetectionMethod.Emrich2023:
#                 nk_params = _t.NK2PeaksEmrich(
#                     window_seconds=self.inputs.peak_emrich_window_seconds.value(),
#                     window_overlap=self.inputs.peak_emrich_window_overlap.value(),
#                     accelerated=self.inputs.peak_emrich_accelerated.isChecked(),
#                 )
#             else:
#                 nk_params = None
...
#                 search_radius=self.inputs.peak_local_max_radius.value(),
#                 min_distance=self.inputs.peak_local_max_min_dist.value(),
#             )

#         elif method == PeakDetectionMethod.LocalMinima:
#             peak_params = _t.PeaksLocalMinima(
#                 search_radius=self.inputs.peak_local_min_radius.value(),
#                 min_distance=self.inputs.peak_local_min_min_dist.value(),
#             )

#         elif method == PeakDetectionMethod.WFDBXQRS:
#             peak_params = _t.PeaksWFDBXQRS(
#                 search_radius=self.inputs.peak_xqrs_search_radius.value(),
#                 peak_dir=WFDBPeakDirection(self.inputs.peak_xqrs_peak_dir.currentData()),
#                 min_peak_distance=self.inputs.peak_xqrs_min_peak_distance.value(),
#             )

#         return peak_params

#     def get_rate_calculation_params(self) -> _t.RollingRateKwargsDict:
#         new_window_every = self.inputs.sb_every_seconds.value()
#         window_length = self.inputs.sb_period_seconds.value()
#         incomplete_window_method = IncompleteWindowMethod(self.inputs.combo_incomplete_window_method.currentData())
...
#         current_input_page = self.inputs.stacked_peak_parameters.currentWidget()
#         for child in current_input_page.children():
#             _reset_widget(child)

#         if current_input_page == self.inputs.page_peak_neurokit2:
#             for child in self.inputs.stacked_nk2_method_parameters.currentWidget().children():
#                 _reset_widget(child)

#     @QtCore.Slot()
#     def _on_restore_defaults_processing(self) -> None:
#         for cb in [
#             self.inputs.combo_pipeline,
#             self.inputs.combo_filter_method,
#             self.inputs.combo_standardize_method,
#         ]:
#             cb.setCurrentIndex(0)

#         for widget_name, default_value in self._processing_defaults.items():
#             widget = getattr(self.inputs, widget_name)

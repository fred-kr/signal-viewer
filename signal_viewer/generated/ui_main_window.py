...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.lview_data_files.setSelectionRectVisible(True)
        ...
        self.lview_annotation_files.setSelectionRectVisible(True)
        ...
        sizePolicy1.setHeightForWidth(self.grp_box_required_info.sizePolicy().hasHeightForWidth())
        ...
        self.verticalLayout_6.addWidget(self.table_view_import_data)
        ...
        self.horizontalLayout.addWidget(self.tabwidget_data_view)
        ...
        QWidget.setTabOrder(self.combo_box_info_column_import_page, self.lview_data_files)
        QWidget.setTabOrder(self.lview_data_files, self.table_view_import_data)
        ...
        self.btn_open_file.clicked.connect(self.action_open_file.trigger)
        self.btn_close_file.clicked.connect(self.action_close_file.trigger)

        self.tab_widget_main.setCurrentIndex(0)
        self.tabwidget_data_view.setCurrentIndex(0)

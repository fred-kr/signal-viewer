...
from PySide6.QtWidgets import QFormLayout, QGridLayout, QSizePolicy, QSpacerItem, QTabWidget, QVBoxLayout, QWidget
from qfluentwidgets import BodyLabel, CaptionLabel, ComboBox, LineEdit, PushButton, SpinBox, SubtitleLabel
...
class Ui_MetadataDialog(object):
    ...
    def retranslateUi(self, MetadataDialog):
        ...
        self.label.setText(QCoreApplication.translate("MetadataDialog", "Metadata", None))
